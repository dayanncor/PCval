...
procesar rapidamente consultas sobre subcadenas cerradas ()'*/
...
//El tamanio del arbol se define como 4 veces el tamanio del string (es estandar).

		seg.resize(4 * size);
		build(1, 1, size - 1, S);
	}
	/* funcion contructora build la cual construye el arbol recursivamente
	desde el indice s hasta e en la posicion idx del arbol */
